...
class ScatterUI(QtWidgets.QDialog):
    ...
    def _name_instances(self, layout):
        self.instance_header_lbl = QtWidgets.QLabel("Name Instances: ")
        self.instance_header_lbl.setStyleSheet("font:bold")

        self.instance_header_le = QtWidgets.QLineEdit()
        self.instance_header_le.setMinimumWidth(100)

        layout.addWidget(self.instance_header_lbl, 5, 5)
        layout.addWidget(self.instance_header_le, 6, 5)
    ...
    def _source_obj_btn_slot(self):
        print("it worked")
        self._create_ui_headers.source_object_le.displayText("it worked")
    ...
    def _name_from_ui(self):
        self.scatter_slot.instance_name = self.instance_header_le()
